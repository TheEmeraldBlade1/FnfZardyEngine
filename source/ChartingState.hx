...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var characters2:Array<String> = CoolUtil.coolTextFile(Paths.txt('characterListDad'));
		...
		var player2DropDown = new FlxUIDropDownMenu(140, 100, FlxUIDropDownMenu.makeStrIdLabelArray(characters2, true), function(character:String)
		{
